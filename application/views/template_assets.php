...
<!-- Select2 -->
<link rel="stylesheet" href="<?=base_url('lte/')?>plugins/select2/css/select2.min.css">
<link rel="stylesheet" href="<?=base_url('lte/')?>plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
...
<link rel="stylesheet" href="<?= base_url('css_custom/custom.css') ?>">
...
<!-- date-range-picker -->
<script src="<?= base_url('/') ?>js_custom/daterange_locale.js"></script>
