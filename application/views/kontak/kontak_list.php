<div class="card">
    <div class="card-body">
        <a class="btn btn-primary" href="<?=base_url('kontak/add')?>" >Add</a>
        <br>
        <br>
        <table id="dtt_tables" class="table table-striped">
            <thead>
                <tr>
                    <th>id</th>
                    <th>#</th>
                    <th><?=label2("jenis kontak")?></th>
                    <th><?=label2("nama_kontak")?></th>
                    <th><?=label2("phone")?></th>
                    <th><?=label2("whatsapp")?></th>
                    <th><?=label2("email")?></th>
                </tr>
            </thead>
            <tbody>
...
<script>
    $(document).ready(function() {
        var table = $('#dtt_tables').DataTable({
            ...
            "ordering": false,
            "processing": true,
            "ajax": '<?=base_url('kontak/datatables')?>',
